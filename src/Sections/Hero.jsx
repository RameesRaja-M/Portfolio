...
import PROFILE_PIC from "../assets/images/Ramees Raja Profile Pic.png"
      ...
      <div className='flex flex-col lg:flex-row gap-14 items-center justify-between mt-[80px]'>
        ...
        <motion.div
          ...
          <div className='flex justify-center lg:justify-start gap-4 md:gap-8 mt-6'>
            ...
            <a
              href={"https://drive.google.com/file/d/1DFAZ67bHNEP8dAwsLy8T10QOFizkOX_U/view?usp=drive_link"}
              target="_blank"
        ...
        <motion.div
          ...
          <img
            src={icon1}
            alt="Icon1 "
            className='icon-img -left-8 md:-left-12 bottom-[88px] rotate-[1.75deg] ' />

          <img
            src={icon2}
            alt="Icon2 "
            className='icon-img left-4 md:left-10 bottom-6 md:bottom-2 rotate-[2.75deg] ' />

          <img
            src={icon3}
            alt="Icon3 "
            className='icon-img left-[110px] md:left-[150px] -bottom-4 rotate-[3.75deg] ' />

          <img
            src={icon4}
            alt="Icon4 "
            className='icon-img left-[210px] md:left-[255px] -bottom-2 md:-bottom-2 rotate-[4.75deg] ' />
